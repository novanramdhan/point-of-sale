...
<head>
  ...
  <link rel="icon" href="<?=base_url()?>/assets/images/wibu.jpg" type="image/png">
...
<body onload="openEyes()">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url(); ?>assets/images/dimaswibu.png" style="width:230px;height:230px;"/><span style="font-size:2em;"class="border bg-white rounded-pill text-2xl fw-bold p-3 text-black ">Irasshaimase</span> 
...
-->
    ...
    <div style="width: 100%">
      ...
      <div style="margin: 40px 40px;">
        ...
        <input style="border-radius: 30px;" onfocus="openEyes();" onblur="movePupilsToCenter();" name="username" id="username" type="text" placeholder="Username">
      </div>
    </div>
    <div style="margin: 40px 40px;">
      <div style="text-align: center">
        <input style="border-radius: 30px;" onfocus="closeEyes();" onblur="openEyes();" name="password" id="password" type="password" placeholder="Password">
      </div>
    </div>
    <div style="margin: 40px 40px;">
      <div style="text-align: center">
        <button style="border-radius: 30px;" type="submit" name="submit">Login</button>
      </div>
      </form>
    </div>
  </div>
