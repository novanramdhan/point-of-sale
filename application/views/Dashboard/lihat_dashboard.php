			...
			<div class="box box-widget widget-user">
				<div class="widget-user-header bg-green-active">
					<p style="text-align: center;">
						<span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di Toko Kami the hass slinging slayser</span>
					</p>
				...
				<div class="box-footer">
					<div class="row">
						...
						<div class="col-sm-4 border-right">
							<div class="description-block">
								<h5 class="description-header">Subang </h5>
								<span class="description-text">No.Telp:081809412834, </span>
							</div>
							<center>
